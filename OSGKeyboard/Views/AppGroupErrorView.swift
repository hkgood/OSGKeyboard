...
struct AppGroupErrorView: View {
    ...
    var body: some View {
        VStack(spacing: Spacing.lg) {
            ...
            Text(AppL10n.string("appGroup.error.title"))
                .font(TypeStyle.title2)
                .multilineTextAlignment(.center)
            Text(AppL10n.string("appGroup.error.body"))
                .font(TypeStyle.body)
                .multilineTextAlignment(.center)
                .foregroundStyle(palette.textSecondary)
            VStack(alignment: .leading, spacing: Spacing.sm) {
                Label(AppL10n.string("appGroup.error.step1"), systemImage: "1.circle")
                Label(AppL10n.string("appGroup.error.step2"), systemImage: "2.circle")
                Label(AppL10n.string("appGroup.error.step3"), systemImage: "3.circle")
            }
            .font(TypeStyle.body)
